...
- IT23221550_Ridmi _Pavithra (1).xlsx → Excel file with test cases & results  
...
4. Run the automation script  
   python test_automation.py --excel " IT23221550_Ridmi _Pavithra (1).xlsx" --url "https://www.pixelssuite.com/chat-translator"  
